...
namespace InventoryScanner.Messaging.Implementation
{
    public class PublisherResponse : IPublisherResponse
    {
        ...
        public List<IRabbitMqEvent> Data { get; } = [];
        IReadOnlyList<IRabbitMqEvent> IPublisherResponse.Data => Data;
        ...
        public PublisherResponse(PublisherResponseStatus status, List<IRabbitMqEvent>? data = null, IEnumerable<string>? errors = null)
        {
            Status = status;
            if (data != null)
                Data.AddRange(data);
        ...
        public static PublisherResponse Success(List<IRabbitMqEvent>? data = null)
        {
            return new(PublisherResponseStatus.Success, data);
        }

        public static PublisherResponse Failed(string[] errors, List<IRabbitMqEvent>? data = null)
        {
